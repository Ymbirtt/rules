...
\item The markers for each team will have numbers that are sequential.
      For example, the second team will have numbers 47 -- 52.

\item Tokens will have human compatible areas, similar to those on robot badges, and which serve the same purpose.
\end{enumerate}
